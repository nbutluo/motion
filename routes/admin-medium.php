...
Route::group(['namespace' => 'Admin'], function () {
    ...
    Route::group(['middleware' => ['auth', 'permission:banner']], function () {
        ...
        Route::get('banner/homepage', [HomepageBannerController::class, 'index'])->name('admin.homepage_banner');
        Route::get('banner/homepage/list', [HomepageBannerController::class, 'getList'])->name('admin.homepage_banner.list');
        Route::get('homepage_banner/create', [HomepageBannerController::class, 'create'])->name('admin.homepage_banner.create');
        Route::PUT('homepage_banner/store', [HomepageBannerController::class, 'store'])->name('admin.homepage_banner.store');
        Route::get('homepage_banner/{banner}/edit', [HomepageBannerController::class, 'edit'])->name('admin.homepage_banner.edit');
        Route::PATCH('homepage_banner/{banner}', [HomepageBannerController::class, 'update'])->name('admin.homepage_banner.update');
        Route::DELETE('homepage_banner/{banner}', [HomepageBannerController::class, 'destroy'])->name('admin.homepage_banner.delete');
    });
});
